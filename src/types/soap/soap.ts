...
import { MAIL_VERIFICATION_HEADERS, MAIL_SENSITIVITY_HEADER_VALUES } from '../../constants';
...
export type MailSensitivityHeader = (typeof MAIL_SENSITIVITY_HEADER_VALUES)[number];
