...
import { getFolder, getFoldersMap } from '../carbonio-ui-commons/store/zustand/folder/hooks';
...
const haveReadReceipt = (
	partecipants: Array<SoapMailParticipant> | undefined,
	...
	if(isNil(folder)) {
		//if folder is nil, filter it inside folder maps by zuid and rid and check for permission
