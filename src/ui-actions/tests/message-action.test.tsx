...
describe('Actions visibility', () => {
	describe('Primary actions', () => {
		...
		test.each`
			...
			${10} | ${FOLDERS.DRAFTS}       | ${CONTAIN_ASSERTION.CONTAIN}     | ${MessageActionsDescriptors.MARK_AS_SPAM}
		...
		test.each`
			...
			${4} | ${MESSAGES_STATUS.READ}     | ${FOLDERS.DRAFTS}       | ${CONTAIN_ASSERTION.CONTAIN}     | ${MessageActionsDescriptors.MARK_AS_UNREAD}
			...
			${5} | ${MESSAGES_STATUS.NOT_READ} | ${FOLDERS.DRAFTS}       | ${CONTAIN_ASSERTION.CONTAIN}     | ${MessageActionsDescriptors.MARK_AS_READ}
