...
// type MoveConvMessagePropType = {
// 	selectedIDs: Array<string>;
// 	openModal: boolean;
// 	closeModal: () => void;
// 	isMessageView: boolean;
// };
// export const MoveConvMessage: FC<MoveConvMessagePropType> = ({
// 	selectedIDs,
// 	openModal,
// 	closeModal,
// 	isMessageView
...
// 				allFolders,
// 				(
// 					a: Array<Folder & { label: string; items: Array<any>; to: string }>,
// 					c: Folder & { name: string }
// 				) => {
// 					a.push({
// 						...c,
// 						id: c.id,
