...
export const getFileExtensionAndColor = (file, theme) => {
	...
	return {
		ext: FileExtensionRegex.exec(file.filename)[1],
		color: getFileExtensionAndColor({ contentType: file.contentType }, theme).color
	};
};
