...
describe('Sorting component', () => {
	...
	test.each`
		case  | folder           | sortingOption                 | sortingDirection
		${1}  | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.unread}     | ${SORTING_DIRECTION.DESCENDING}
		${2}  | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.unread}     | ${SORTING_DIRECTION.DESCENDING}
		${3}  | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.important}  | ${SORTING_DIRECTION.DESCENDING}
		${4}  | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.important}  | ${SORTING_DIRECTION.DESCENDING}
		${5}  | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.flagged}    | ${SORTING_DIRECTION.DESCENDING}
		${6}  | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.flagged}    | ${SORTING_DIRECTION.DESCENDING}
		${7}  | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.attachment} | ${SORTING_DIRECTION.DESCENDING}
		${8}  | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.attachment} | ${SORTING_DIRECTION.DESCENDING}
		${9}  | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.from}       | ${SORTING_DIRECTION.DESCENDING}
		${10} | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.from}       | ${SORTING_DIRECTION.DESCENDING}
		${11} | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.to}         | ${SORTING_DIRECTION.DESCENDING}
		${12} | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.to}         | ${SORTING_DIRECTION.DESCENDING}
		${13} | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.date}       | ${SORTING_DIRECTION.DESCENDING}
		${14} | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.date}       | ${SORTING_DIRECTION.DESCENDING}
		${15} | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.subject}    | ${SORTING_DIRECTION.DESCENDING}
		${16} | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.subject}    | ${SORTING_DIRECTION.DESCENDING}
		${17} | ${FOLDERS.INBOX} | ${SORTING_OPTIONS.size}       | ${SORTING_DIRECTION.DESCENDING}
		${18} | ${FOLDERS.SENT}  | ${SORTING_OPTIONS.size}       | ${SORTING_DIRECTION.DESCENDING}
	`(
		`(case #$case) selecting order by $sortingOption.label.$sortingDirection`,
		async ({ folder, sortingOption, sortingDirection }) => {
			const store = generateStore();
			const customSettings: Partial<AccountSettings> = {
				prefs: {
					zimbraPrefSortOrder: `${folder}:${sortingOption.value}${sortingDirection},BDLV:,CAL:,CLV:,CLV-SR-1:dateDesc,CLV-SR-2:dateDesc,CLV-main:dateDesc,CNS:,CNSRC:,CNTGT:,CV:,TKL:,TKL-main:taskDueAsc,TV:,TV-main:dateDesc`
				}
			};
			const props = { ...defaultProps, folderId: folder };
